    ...
    return (
        <>
            ...
            <div className='w-[90%] mx-auto flex flex-col md:flex-row justify-between items-center bg-white  text-[#290088] my-[100px] ' >
                <div className=' text-[32px] my-10  md:w-[25%]  flex justify-start items-center gap-4'>
                    <img src={Oval} alt='' className='border-2 border-black border-solid rounded-[50%] p-5' />
                    <div>
                        <h1>Admin</h1>
                        <p className='text-[#999999]'>July 05 , 2022</p>
                    </div>
                </div>
                <div className='w-full md:w-[68%]'>
                    <h1 className=' text-[32px] md:text-[52px] my-10 lg:w-[80%] '>High Point Announce
                        Partnership With
                        Huawai
                    </h1>
                    <p className='my-10 md:text-[20px] lg:w-[60%]'>Today we will be explaining what it is, why it’s important and how it’s going to integrate itself into our everyday lives.
                    ...
                    <p className='my-40 md:text-[20px] lg:w-[60%]'>
